...
<html>
  ...
  <body class="impress-not-supported">
    ...
    <!-- <div style="position:relative;background-color:#5C86F1;top:10px;width:100%;box-shadow: -5px -5px 10px #777">Topic</div> -->
    <div >
      <img style=" padding: 10px 10px;float:right" src="headerright.png"  height="60px"/>
    </div>
    <div >
      <img style=" padding: 10px 10px;float:left" src="headerleft.png"  height="60px"/>
    </div>
    <div style="background-color:#99cc55;position:absolute;bottom:10px;width:99%;box-shadow: -5px -5px 10px #777">
     <span style="font-size:60%;position:relative; float:left;margin-left: 0.4em;margin-top: 0.5em;color:#2f2f2f">
      Richard Macwan
     </span> 
     <span style="font-size:70%;position:relative; color:#2f2f2f">
      Non-contact physiological signs measurement
     </span> 
    <span id="slide_number" style="float:right;margin-right:0.5em;color:#2f2f2f">
